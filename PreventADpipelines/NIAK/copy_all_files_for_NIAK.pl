...
#    print "$enc_name \n";
#    if($enc_name =~ /(PreventAD)_([0-9][0-9][0-9][0-9][0-9][0-9])_([N,P,Y][A,R,N][P,E,G][B,F,V][L,U,I][0-9][0-9])_(Encoding)_([0-9][0-9][0-9].mnc)/m) {
#        my $DCCID = $2;
#        my $visitLabel = $3;
#        my $acquisition = "$4$5";
#        print "mkdir $DCCID \n";
...
#    print "$ret_name \n";
#    if($ret_name =~ /(PreventAD)_([0-9][0-9][0-9][0-9][0-9][0-9])_([N,P,Y][A,R,N][P,E,G][B,F,V][L,U,I][0-9][0-9])_(Retrieval)_([0-9][0-9][0-9].mnc)/m) {
#        my $DCCID = $2;
#        my $visitLabel = $3;
#        my $acquisition = "$4$5";
#        print "mkdir $DCCID \n";
...
#    print "$asl_name \n";
#    if($asl_name =~ /(PreventAD)_([0-9][0-9][0-9][0-9][0-9][0-9])_([N,P,Y][A,R,N][P,E,G][B,F,V][L,U,I][0-9][0-9])_(ASL)_([0-9][0-9][0-9].mnc)/m) {
#        my $DCCID = $2;
#        my $visitLabel = $3;
#        my $acquisition = "$4$5";
#        print "mkdir $DCCID \n";
